function [ ba, bg, bm, dv, dr, epsilon, innov, Sk_diag, Pk_diag ]...
...
Pinitial = diag([2; 2; 2; 2; 2; 2; 0.01; 0.01; 0.01; 1; 1; 1; 100; 100; 100; 25; 25; 25]);
...
Ft = [  zeros(3,3), eye(3),     zeros(3,3),     zeros(3,3),        zeros(3,3), zeros(3,3);
        zeros(3,3), zeros(3,3), fn_cross,       zeros(3,3),        mg2ms(Cs2n), zeros(3,3);
...
Hk = [ eye(3),     zeros(3,3),     zeros(3,3),                  zeros(3,3),     zeros(3,3),     zeros(3,3);
       zeros(3,3), zeros(3,3),     Cn2s*mat_cross(gn_cal),      zeros(3,3),     eye(3),         zeros(3,3); 
       zeros(3,3), zeros(3,3),     Cn2s*mat_cross(mn_cal),      zeros(3,3),     zeros(3,3),     eye(3)];
